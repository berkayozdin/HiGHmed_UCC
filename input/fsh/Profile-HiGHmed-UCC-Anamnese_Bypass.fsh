...
Profile: Profile_HiGHmed_UCC_Procedure_Bypass
Parent: Procedure
Id: Profile-HiGHmed-UCC-Procedure-Bypass
Title: "HiGHmed UCC Procedure Bypass"
Description: "Dieses Profil beschreibt eine Prozedur in der HiGHmed UCC Bypass"
...
Instance: Example-Procedure-Bypass
...
* code.coding.code = $SCT#232717009 
* code.coding.display = "Coronary artery bypass grafting (procedure)"
