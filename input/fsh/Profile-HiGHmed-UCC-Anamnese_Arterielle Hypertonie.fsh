Profile: Profile_HiGHmed_UCC_Anamnese_Arterielle_Hypertonie
Parent: Observation
Id: Profile-HiGHmed-UCC-Anamnese-Arterielle-Hypertonie
Title: "HiGHmed UCC Arterielle Hypertonie Observation"
Description: "Arterielle Hypertonie Observation"
* insert RuleSet1
...
* code from vs-highmed-ucc-risikofaktoren-snomed-ct (required)
// subject 
* subject MS
...
Instance: Example-Anamnese-Arterielle-Hypertonie
InstanceOf: Profile_HiGHmed_UCC_Anamnese_Arterielle_Hypertonie
Usage: #example
...
* code.coding.code = $SCT#11399002 
* code.coding.display = "Pulmonary hypertensive arterial disease (disorder)"
