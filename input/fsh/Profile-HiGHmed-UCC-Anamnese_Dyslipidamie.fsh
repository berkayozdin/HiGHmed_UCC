Profile: Profile_HiGHmed_UCC_Anamnese_Dyslipidamie
Parent: Observation
Id: Profile-HiGHmed-UCC-Anamnese-Dyslipidamie
Title: "HiGHmed UCC Dyslipidämie Observation"
Description: "Dyslipidämie Observation"
* insert RuleSet1
...
Instance: Example-Anamnese-Dyslipidamie
InstanceOf: Profile_HiGHmed_UCC_Anamnese_Dyslipidamie
Usage: #example
...
* code.coding.code = $SCT#370992007 
* code.coding.display = "Dyslipidemia (disorder)"
