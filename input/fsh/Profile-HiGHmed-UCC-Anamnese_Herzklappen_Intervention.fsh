...
Profile: Profile_HiGHmed_UCC_Procedure_Herzklappen_Intervention
Parent: Procedure
Id: Profile-HiGHmed-UCC-Procedure-Herzklappen-Intervention
Title: "HiGHmed UCC Procedure Herzklappen_Intervention"
Description: "Dieses Profil beschreibt eine Prozedur in der HiGHmed UCC Herzklappen_Intervention"
...
* bodySite MS
* bodySite from vs-highmed-ucc-anamnese-bisherige-interventionen-snomed-ct (required)
...
Instance: Example-Procedure-Herzklappen-Intervention
...
* code.coding.code = $SCT#118798003 
* code.coding.display = "Procedure on heart valve (procedure)"
* performedDateTime = "2021-05-16T08:49:21+02:00"
* bodySite.coding.code = $SCT#34202007 "Aortic valve structure (body structure)"