Profile: Profile_HiGHmed_UCC_Anamnese_Kardiomyopathie
Parent: Observation
Id: Profile-HiGHmed-UCC-Anamnese-Kardiomyopathie
Title: "HiGHmed UCC Kardiomyopathie Observation"
Description: "Kardiomyopathie Observation"
* insert RuleSet1
...
Instance: Example-Anamnese-Kardiomyopathie
InstanceOf: Profile_HiGHmed_UCC_Anamnese_Kardiomyopathie
Usage: #example
...
* code.coding.code = $SCT#85898001
* code.coding.display = "Cardiomyopathy (disorder)"
