Profile: Profile_HiGHmed_UCC_Anamnese_Dekompensation
Parent: Observation
Id: Profile-HiGHmed-UCC-Anamnese-Dekompensation
Title: "HiGHmed UCC Dekompensation Observation"
Description: "Dekompensation Observation"
* insert RuleSet1
...
Instance: Example-Anamnese-Dekompensation
InstanceOf: Profile_HiGHmed_UCC_Anamnese_Dekompensation
Usage: #example
...
* code.coding.code = $SCT#87228002
* code.coding.display = "Decompensation (finding)"
