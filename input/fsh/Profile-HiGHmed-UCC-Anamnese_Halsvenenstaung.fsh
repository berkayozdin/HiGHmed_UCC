Profile: Profile_HiGHmed_UCC_Anamnese_Halsvenenstaung
Parent: Observation
Id: Profile-HiGHmed-UCC-Anamnese-Halsvenenstaung
Title: "HiGHmed UCC Halsvenenstaung Observation"
Description: "Halsvenenstaung Observation"
* insert RuleSet1
...
Instance: Example-Anamnese-Halsvenenstaung
InstanceOf: Profile_HiGHmed_UCC_Anamnese_Halsvenenstaung
Usage: #example
...
* code.coding.code = $SCT#63363004 
* code.coding.display = "Superior vena cava syndrome (disorder)"
