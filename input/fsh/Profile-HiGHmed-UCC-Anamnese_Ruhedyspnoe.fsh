Profile: Profile_HiGHmed_UCC_Anamnese_Ruhedyspnoe
Parent: Observation
Id: Profile-HiGHmed-UCC-Anamnese-Ruhedyspnoe
Title: "HiGHmed UCC Ruhedyspnoe Observation"
Description: "Ruhedyspnoe Observation"
* insert RuleSet1
...
Instance: Example-Anamnese-Ruhedyspnoe
InstanceOf: Profile_HiGHmed_UCC_Anamnese_Ruhedyspnoe
Usage: #example
...
* code.coding.code = $SCT#161941007 
* code.coding.display = "Dyspnea at rest (finding)"
