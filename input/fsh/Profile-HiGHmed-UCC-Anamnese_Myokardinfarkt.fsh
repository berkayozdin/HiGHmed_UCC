Profile: Profile_HiGHmed_UCC_Anamnese_Myokardinfarkt
Parent: Observation
Id: Profile-HiGHmed-UCC-Anamnese-Myokardinfarkt
Title: "HiGHmed UCC Myokardinfarkt Observation"
Description: "Myokardinfarkt Observation"
* insert RuleSet1
...
Instance: Example-Anamnese-Myokardinfarkt
InstanceOf: Profile_HiGHmed_UCC_Anamnese_Myokardinfarkt
Usage: #example
...
* code.coding.code = $SCT#22298006
* code.coding.display = "Myocardial infarction (disorder)"
