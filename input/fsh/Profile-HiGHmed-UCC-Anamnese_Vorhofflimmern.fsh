Profile: Profile_HiGHmed_UCC_Anamnese_Vorhofflimmern
Parent: Observation
Id: Profile-HiGHmed-UCC-Anamnese-Vorhofflimmern
Title: "HiGHmed UCC Vorhofflimmern Observation"
Description: "Vorhofflimmern Observation"
* insert RuleSet1
...
Instance: Example-Anamnese-Vorhofflimmern
...
* code.coding.code = $SCT#49436004 
* code.coding.display = "Atrial fibrillation (disorder)"
