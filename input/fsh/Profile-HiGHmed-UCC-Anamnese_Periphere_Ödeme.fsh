Profile: Profile_HiGHmed_UCC_Anamnese_Periphere_Odeme
Parent: Observation
Id: Profile-HiGHmed-UCC-Anamnese-Periphere-Odeme
Title: "HiGHmed UCC Periphere_Odeme Observation"
Description: "Periphere_Odeme Observation"
* insert RuleSet1
...
Instance: Example-Anamnese-Periphere-Odeme
InstanceOf: Profile_HiGHmed_UCC_Anamnese_Periphere_Odeme
Usage: #example
...
* code.coding.code = $SCT#271809000 
* code.coding.display = "Peripheral edema (disorder)"
